...
public class UtilDB {
	 ...
	 * createConnection(String, String, String). L'utilit� di tutto questo sta
	 * nel fatto che in futuro cambiare il database a cui si accede � molto
	 ...
	 * in modo che possa essere pi� facilmente gestito per la stampa da parte di 
	 * un'applicazione.
	...
	public void printTableColumnsNames(Connection conn, String tableName) throws SQLException{
		...
		while (rs.next()) {
			String columnName = rs.getString(4); // d� il nome della colonna
