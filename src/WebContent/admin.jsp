...
<body>
	...
	<button onclick="window.location.assign('displayCheckBoxCategories.action?flag=survey');">Crea sondaggio</button>
	<button onclick="window.location.assign('displayListCategories.action');">Inserisci nuova categoria</button>
	<button onclick="window.location.assign('displayRadioCategories.action');">Cancella categoria</button>
